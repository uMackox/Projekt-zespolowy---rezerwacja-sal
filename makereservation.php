<?php
    ...
    if(!isset($_SESSION['availability'])) {
        ...
        <form action="makereservation.php" method="post">
            Date : <input type="date" id="resdate" name="resdate" required><br>
            Start hour : <input type="number" id="hstart" name="hstart" maxlength="2" max="23"><br>
            End hour : <input type="number" id="hend" name="hend" maxlength="2" max="24"><br>
        ...
        ?>
        <form action="makereservation.php" method="post">
            Selected date and hours are available. Do you want to make reservation?<br>
            <label for="confirm">Yes</label>
            <input type="radio" name="confirmation" id="confirm" value="yes">
            <label for="decline">No</label>
